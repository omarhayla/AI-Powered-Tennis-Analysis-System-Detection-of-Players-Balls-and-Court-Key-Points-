...
class MiniCourt():
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self, player_boxes, ball_boxes, original_court_key_points):
        ...
        DEFAULT_PLAYER_HEIGHT = 1.8  # Default height in meters
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            for player_id, bbox in player_bbox.items():
                ...
                if player_id not in player_heights:
                    print(
                        f"Warning: player_id {player_id} not found in player_heights. Using default height: {DEFAULT_PLAYER_HEIGHT}.")
                    player_height_meters = DEFAULT_PLAYER_HEIGHT
                else:
                    player_height_meters = player_heights[player_id]
